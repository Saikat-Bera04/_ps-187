...
export function ProblemSection() {
  return (
    <section className="relative z-10 w-full max-w-5xl mx-auto px-6 py-24 flex flex-col items-center">
      <div className="text-[#37B9FF] text-xs font-bold tracking-[0.15em] uppercase mb-4">THE CHALLENGE</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        {[
          { icon: <Eye className="text-[#37B9FF]" />, title: 'Continuous Monitoring', desc: 'Multiple camera feeds require constant attention, making it difficult for operators to identify every critical event.' },
          { icon: <Clock className="text-[#FF5C67]" />, title: 'Delayed Response', desc: 'Suspicious movement or unauthorized activity may go unnoticed until after an incident occurs.' },
          { icon: <Network className="text-[#39D98A]" />, title: 'Limited Intelligence', desc: 'Existing CCTV infrastructure often lacks integrated AI analytics, threat scoring, and centralized investigation.' },
          ...
          <div key={i} className="bg-[#141C24]/80 backdrop-blur-md border border-[#263442] p-8 rounded-2xl flex flex-col items-start hover:border-[#37B9FF]/50 transition-colors">
            <div className="w-12 h-12 rounded-full bg-[#1A2633] flex items-center justify-center mb-6 border border-[#263442]">
              {item.icon}
            </div>
            <h3 className="text-white font-bold text-xl mb-3">{item.title}</h3>
            <p className="text-[#A7B2BD] leading-relaxed text-sm">{item.desc}</p>
          </div>
        ))}
      </div>
    </section>
...
export function SolutionSection() {
  return (
    <section className="relative z-10 w-full max-w-6xl mx-auto px-6 py-24 flex flex-col items-center">
      <div className="text-[#39D98A] text-xs font-bold tracking-[0.15em] uppercase mb-4">THE IBVAP APPROACH</div>
      <h2 className="text-4xl md:text-[56px] font-[family-name:var(--font-display)] text-white text-center mb-6 leading-[1.15] tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
        {[
          ...
          <div key={i} className="group relative bg-[#0B1116]/80 backdrop-blur-md border border-[#1A2633] p-8 rounded-2xl hover:bg-[#141C24] transition-all overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="w-10 h-10 text-[#37B9FF] mb-5">
                {item.icon}
              </div>
              <h3 className="text-white font-bold text-xl mb-3 flex items-center gap-3">
                <span className="text-[#A7B2BD] text-sm font-normal">{item.num} —</span>
                {item.title}
              </h3>
              <p className="text-[#A7B2BD] leading-relaxed text-sm">{item.desc}</p>
            </div>
    ...
    <section className="relative z-10 w-full max-w-6xl mx-auto px-6 py-24 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 w-full">
        {capabilities.map((item, i) => (
          <div key={i} className="bg-gradient-to-b from-[#141C24] to-[#0B1116] border border-[#263442] p-6 rounded-xl hover:border-[#F5A623]/50 transition-colors">
...
export function ResponseSection() {
  return (
    <section className="relative z-10 w-full max-w-5xl mx-auto px-6 py-24 flex flex-col items-center">
      <div className="text-[#FF5C67] text-xs font-bold tracking-[0.15em] uppercase mb-4">REAL-TIME RESPONSE</div>
      <h2 className="text-4xl md:text-[56px] font-[family-name:var(--font-display)] text-white text-center mb-6 leading-[1.15] tracking-tight">
      ...
      {/* Alert Card Mockup */}
      <div className="w-full max-w-2xl bg-[#0F151C] border border-[#FF5C67]/30 rounded-2xl overflow-hidden shadow-2xl shadow-[#FF5C67]/5">
        <div className="bg-[#FF5C67]/10 px-6 py-4 flex items-center justify-between border-b border-[#FF5C67]/20">
          <div className="flex items-center gap-3">
            <div className="w-2 h-2 rounded-full bg-[#FF5C67] animate-pulse"></div>
            <span className="text-[#FF5C67] font-bold text-sm tracking-wider">CRITICAL ALERT</span>
          </div>
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="grid grid-cols-2 gap-y-6 gap-x-8 mb-8">
            ...
            <div>
              ...
              <div className="text-white font-mono text-sm text-[#37B9FF]">02:41:38</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-[#39D98A] font-mono text-sm">96.2%</div>
            </div>
            <div>
              <div className="text-[#8e8e8e] text-xs uppercase tracking-wider mb-1">Threat Score</div>
              <div className="text-[#FF5C67] font-mono text-sm font-bold flex items-center gap-2">
                87 <span className="text-[#8e8e8e] font-normal text-xs">/ 100</span>
              </div>
            </div>
          </div>

          <div className="flex flex-wrap gap-3 pt-6 border-t border-[#263442]">
            <button className="px-5 py-2.5 bg-[#FF5C67] text-black font-bold text-xs rounded-lg hover:bg-[#ff757e] transition-colors">
              ACKNOWLEDGE
            </button>
            <button className="px-5 py-2.5 bg-[#263442] text-white font-bold text-xs rounded-lg hover:bg-[#324558] transition-colors">
              INVESTIGATE
            </button>
            <button className="px-5 py-2.5 bg-transparent border border-[#263442] text-[#A7B2BD] font-bold text-xs rounded-lg hover:text-white transition-colors">
              VIEW CAMERA
            </button>
          </div>
        </div>
  ...
  return (
    <section className="relative z-10 w-full max-w-5xl mx-auto px-6 py-24 flex flex-col md:flex-row items-center gap-16">
      ...
      <div className="flex-1 w-full">
        <div className="bg-[#141C24] border border-[#263442] rounded-2xl p-6 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-8">
            ...
            <div className="px-3 py-1 bg-[#39D98A]/10 border border-[#39D98A]/30 rounded text-[#39D98A] text-[10px] font-bold tracking-widest flex items-center gap-1.5">
              <CheckCircle className="w-3 h-3" /> VERIFIED
            </div>
          </div>

          <div className="space-y-4 mb-8">
            <div className="flex justify-between border-b border-[#263442] pb-3">
          ...
          <div className="bg-[#0B1116] rounded-lg p-4 border border-[#263442]">
            ...
            <div className="text-[#A7B2BD] font-mono text-[11px] break-all">
...
export function BlockchainSection() {
  return (
    <section className="relative z-10 w-full max-w-6xl mx-auto px-6 py-24 flex flex-col items-center border-t border-[#263442]/50">
      <div className="text-[#39D98A] text-xs font-bold tracking-[0.15em] uppercase mb-4">TRUST & INTEGRITY</div>
      <h2 className="text-4xl md:text-[56px] font-[family-name:var(--font-display)] text-white text-center mb-6 leading-[1.15] tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-16">
        {[
          ...
          <div key={i} className="bg-[#141C24]/50 border border-[#263442] p-8 rounded-2xl flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full bg-[#1A2633] flex items-center justify-center mb-5 text-[#39D98A]">
              {item.icon}
            </div>
      ...
      <div className="w-full flex items-center justify-between overflow-x-auto pb-4 gap-4 px-4 text-[#A7B2BD] font-mono text-xs opacity-70">
        ...
        <ArrowRight className="shrink-0" />
        <div className="flex flex-col items-center gap-3 shrink-0 text-[#39D98A]"><Layers className="w-6 h-6" /> HYPERLEDGER FABRIC</div>
        <ArrowRight className="shrink-0" />
...
export function CommandCenterSection() {
  return (
    <section className="relative z-10 w-full max-w-5xl mx-auto px-6 py-24 border-t border-[#263442]/50">
      <div className="flex flex-col items-start mb-12">
        <div className="text-[#37B9FF] text-xs font-bold tracking-[0.15em] uppercase mb-4">COMMAND CENTER</div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
        {[
          ...
          { label: 'Online', value: '124', color: 'text-[#39D98A]' },
          { label: 'Active Alerts', value: '06', color: 'text-[#FF5C67]' },
          { label: 'AI Events Today', value: '1,284' },
          { label: 'Evidence Records', value: '342' },
          { label: 'System Health', value: '98.7%' },
        ].map((stat, i) => (
          <div key={i} className="bg-[#141C24] border border-[#263442] p-5 rounded-xl">
      ...
      <div className="flex flex-wrap gap-3">
        {['Live Surveillance', 'Camera Management', 'Alerts', 'Events', 'Investigation', 'Evidence', 'Border Map', 'Watchlist', 'Analytics', 'System Health'].map((module, i) => (
          <div key={i} className="px-4 py-2 border border-[#263442] rounded-full text-[#A7B2BD] text-sm bg-[#0B1116]">
            {module}
          </div>
        ))}
      </div>
...
export function AdditionalSections() {
  return (
    <>
      {/* 9. Camera Management */}
      <section className="relative z-10 w-full max-w-5xl mx-auto px-6 py-24 flex flex-col md:flex-row items-center gap-16 border-t border-[#263442]/50">
        <div className="flex-1 w-full order-2 md:order-1">
          <div className="bg-[#141C24] border border-[#263442] rounded-xl p-6 max-w-md mx-auto relative overflow-hidden">
             <div className="flex justify-between items-start mb-6">
               ...
               <div className="text-[#39D98A] text-xs font-bold tracking-widest flex items-center gap-2">
             ...
             <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
               ...
               <div><span className="text-[#8e8e8e]">AI:</span> <span className="text-[#37B9FF] font-bold">ENABLED</span></div>
             </div>
             <div className="flex gap-3 border-t border-[#263442] pt-5">
               <button className="flex-1 py-2 bg-[#263442] text-white text-xs font-bold rounded">VIEW CAMERA</button>
               <button className="flex-1 py-2 border border-[#263442] text-[#A7B2BD] text-xs font-bold rounded hover:text-white">EVENTS</button>
             </div>
          </div>
        </div>
        <div className="flex-1 order-1 md:order-2">
          <div className="text-[#37B9FF] text-xs font-bold tracking-[0.15em] uppercase mb-4">CAMERA INTELLIGENCE</div>
      ...
      <section className="relative z-10 w-full max-w-5xl mx-auto px-6 py-24 flex flex-col md:flex-row items-center gap-16 border-t border-[#263442]/50">
        ...
        <div className="flex-1 w-full">
           <div className="bg-[#141C24] border border-[#F5A623]/30 rounded-xl p-6 max-w-md mx-auto shadow-2xl">
             <div className="text-white font-bold text-lg mb-6 tracking-wide">SECTOR NORTH-04</div>
             <div className="space-y-4 text-sm font-mono text-[#A7B2BD]">
               <div className="flex justify-between border-b border-[#263442] pb-2"><span>BOPs:</span> <span className="text-white">08</span></div>
               <div className="flex justify-between border-b border-[#263442] pb-2"><span>Cameras:</span> <span className="text-white">24</span></div>
               <div className="flex justify-between border-b border-[#263442] pb-2"><span>Online:</span> <span className="text-[#39D98A]">23</span></div>
               <div className="flex justify-between border-b border-[#263442] pb-2"><span>Active Alerts:</span> <span className="text-[#FF5C67]">02</span></div>
      ...
      {/* 11. Investigation */}
      <section className="relative z-10 w-full max-w-6xl mx-auto px-6 py-24 flex flex-col md:flex-row items-center gap-16 border-t border-[#263442]/50">
        <div className="flex-1">
          <div className="text-[#37B9FF] text-xs font-bold tracking-[0.15em] uppercase mb-4">SECURITY INVESTIGATION</div>
          ...
          <div className="grid grid-cols-2 gap-3 text-sm text-[#A7B2BD]">
            {[
              ...
              <div key={i} className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-[#37B9FF]/50"></div> {item}
              </div>
            ))}
          </div>
        </div>
        <div className="flex-1 w-full bg-[#0B1116] border border-[#263442] rounded-2xl p-8">
           <div className="space-y-6 relative before:absolute before:inset-0 before:ml-[11px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-[#37B9FF]/30 before:to-transparent">
             {[
               ...
               { time: '02:41:38', text: 'Security alert generated.', color: 'text-[#FF5C67]' },
               { time: '02:41:39', text: 'Evidence captured.', color: 'text-[#8b5cf6]' },
               { time: '02:41:40', text: 'Evidence hash registered.', color: 'text-[#39D98A]' },
             ].map((step, i) => (
               <div key={i} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                  <div className="flex items-center justify-center w-6 h-6 rounded-full bg-[#141C24] border border-[#37B9FF] text-[#37B9FF] shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
                    <div className="w-2 h-2 bg-[#37B9FF] rounded-full"></div>
                  </div>
                  <div className="w-[calc(100%-3rem)] md:w-[calc(50%-2rem)] bg-[#1A2633] p-4 rounded border border-[#263442] shadow">
                    <div className="text-white font-mono text-xs mb-1">{step.time}</div>
                    <div className={`text-sm ${step.color || 'text-[#A7B2BD]'}`}>{step.text}</div>
                  </div>
               </div>
             ))}
           </div>
      ...
      {/* 12. Security Section */}
      <section className="relative z-10 w-full max-w-5xl mx-auto px-6 py-24 flex flex-col items-center border-t border-[#263442]/50">
        <div className="text-[#39D98A] text-xs font-bold tracking-[0.15em] uppercase mb-4">SECURITY BY DESIGN</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
          {[
            ...
            { title: 'Audit Logging', desc: 'Important system and evidence operations are recorded for accountability.' },
             ...
             <div key={i} className="bg-[#141C24]/50 border border-[#263442] p-6 rounded-xl hover:border-[#39D98A]/40 transition-colors">
      ...
      <section className="relative z-10 w-full max-w-5xl mx-auto px-6 py-24 border-t border-[#263442]/50">
         <div className="text-[#37B9FF] text-xs font-bold tracking-[0.15em] uppercase mb-4 text-center">OPERATIONAL USE CASES</div>
         <h2 className="text-4xl md:text-[48px] font-[family-name:var(--font-display)] text-white text-center mb-16 leading-[1.15] tracking-tight">
         ...
         <div className="grid grid-cols-2 md:grid-cols-3 gap-4 w-full">
           {[
             ...
             <div key={i} className="bg-[#141C24] border border-[#263442] p-6 rounded-lg text-center">
               <h3 className="text-white font-bold text-sm mb-2">{item.title}</h3>
               <p className="text-[#8e8e8e] text-xs leading-relaxed">{item.desc}</p>
             </div>
           ))}
      ...
      <section className="relative z-10 w-full max-w-4xl mx-auto px-6 py-32 flex flex-col items-center text-center">
         <div className="text-[#37B9FF] text-xs font-bold tracking-[0.15em] uppercase mb-4">INTELLIGENT SURVEILLANCE • SECURE EVIDENCE</div>
         ...
         <div className="flex flex-col sm:flex-row items-center gap-4">
           <Link href="/login" className="px-8 py-4 bg-white text-black font-bold text-sm rounded-full flex items-center gap-2 hover:bg-[#37B9FF] hover:scale-105 transition-all shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(55,185,255,0.4)]">
    ...
    <footer className="relative z-10 w-full bg-[#070B0F] border-t border-[#1A2633] pt-20 pb-8 px-6 text-sm">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="md:col-span-1">
          ...
          <p className="text-[#A7B2BD] text-xs leading-relaxed mb-6 pl-3 border-l-2 border-[#263442]">
            Transforming existing CCTV infrastructure into intelligent, secure, and auditable surveillance.
          </p>
          <div className="flex items-center gap-2 text-[#39D98A] text-xs font-mono font-bold">
